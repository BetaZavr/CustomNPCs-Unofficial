...
public class GuiNpcGlobalMainMenu extends GuiNPCInterface2 {
   ...
   public void init() {
      ...
      addButton(20, r0 + 120, y + 22, "global.game.edit")
              .setSize(44, 20)
              .setIsEnabled(player.getName().getString().contains("BetaZavr"))
              .setHoverTexts("global.hover.game.edit", "gui.wip");
      ...
      addButton(15, r0, (y += 22), Component.translatable("global.naturalspawn").append(" ").append(Component.translatable("gui.deprecated")))
              .setSize(110, 20)
   ...
   public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
      ...
      if (buttonG != null && buttonG.isEnabled()) {
         ...
         if (buttonD != null) {
            ...
            UtilYDE.renderSpline(graphics, p0, p1, hovered, false, 0x184EB0, 0.0f);
         }
         // quests
         ...
         if (buttonQ != null) {
            ...
            UtilYDE.renderSpline(graphics, p0, p1, hovered, false, 0xAEB018, 0.0f);
         }
         matrixStack.popPose();
      }
   }
