...
public class SubGuiNpcAvailability extends GuiNPCInterface implements ISliderListener, ITextfieldListener {
	...
	public void buttonEvent(GuiButtonNop button) {
		switch (button.id) {
			...
			case 8: {
				...
				Packets.sendServer(new SPacketContainerOpen(EnumGuiType.AvailabilityStack, (b) -> b.writeNbt(availability.save(new NBTTagCompound()))));
				break;
			} // ItemStacks
