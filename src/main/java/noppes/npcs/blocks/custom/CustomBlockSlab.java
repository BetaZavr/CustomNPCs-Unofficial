...
public class CustomBlockSlab extends SlabBlock implements ICustomElement {

    protected final @Nonnull CompoundTag nbtData;

    public CustomBlockSlab(@Nonnull Properties properties, @Nonnull CompoundTag nbtBlock) {
        super(properties);
        nbtData = nbtBlock;
    }
